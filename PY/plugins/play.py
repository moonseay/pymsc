...
from PY import call_py, PY, client as Client
owner = "1669178360"
from PY.helpers.yt_dlp import bash
from PY.helpers.chattitle import CHAT_TITLE
from PY.helpers.queues import (
    QUEUE,
    add_to_queue,
    clear_queue,
    get_queue,
...
from PY.helpers.thumbnail import gen_thumb
from PY.helpers.joiner import AssistantAdd
...
@PY.on(events.callbackquery.CallbackQuery(data="cls"))
async def _(event):
...
#play
@PY.on(events.NewMessage(pattern="^[?!/]play"))
@AssistantAdd
...
#end
@PY.on(events.NewMessage(pattern="^[/?!]end"))
@is_admin
...
@PY.on(events.NewMessage(pattern="^[?!/]vplay"))
@AssistantAdd
...
#playlist
@PY.on(events.NewMessage(pattern="^[?!/]playlist"))
@is_admin
...
#leavevc
@PY.on(events.NewMessage(pattern="^[?!/]leavevc"))
@is_admin
...
@PY.on(events.NewMessage(pattern="^[?!/]skip"))
@is_admin
...
@PY.on(events.NewMessage(pattern="^[?!/]pause"))
@is_admin
...
@PY.on(events.NewMessage(pattern="^[?!/]resume"))
@is_admin
